...
class CustomerResource(
    ...
    @PostMapping
    fun saveCustomer(@RequestBody @Valid customertDto : CustomerDto) : ResponseEntity<CustomerView> {
        val saveCustomer : Customer = this.customerService.save(customertDto.toEntity())
